...
def test_list_tags_security_group():
    ...
    resource = 'arn:aws:rds:us-west-2:1234567890:secgrp:{}'.format(security_group)
...
def test_list_tags_database_subnet_group():
    ...
    result = conn.list_tags_for_resource(ResourceName='arn:aws:rds:us-west-2:1234567890:subgrp:{}'.format(subnet))
    result['TagList'].should.equal([{'Value': 'bar',
                                     'Key': 'foo'},
                                     {'Value': 'bar1',
                                      'Key': 'foo1'}])
...
def test_add_tags_database_subnet_group():
    ...
    resource = 'arn:aws:rds:us-west-2:1234567890:subgrp:{}'.format(subnet)
